...
const techs = {
  ...
  Languages: [
    ...
    { icon: <SiMysql />, href: 'https://en.wikipedia.org/wiki/SQL', name: 'SQL' },
    // { icon: <SiMathworks />, href: 'https://www.mathworks.com/products/matlab.html', name: 'MATLAB' },
  ],
  ...
  "Developer Tools": [
    ...
    { icon: <SiJupyter />, href: 'https://jupyter.org/', name: 'Jupyter Notebook' },
    { icon: <SiGooglecolab />, href: 'https://colab.research.google.com/', name: 'Google Colab' },
  ],
